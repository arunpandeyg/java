package com.appsbs.apsbs.service;


import com.appsbs.apsbs.config.jwtAuth.JwtTokenGenerator;
import com.appsbs.apsbs.dto.AuthResponseDto;
import com.appsbs.apsbs.dto.TokenType;
...
import com.appsbs.apsbs.mapper.UserInfoMapper;
import com.appsbs.apsbs.repository.RefreshTokenRepo;
import com.appsbs.apsbs.repository.UserInfoRepo;
...
public class AuthService {
    ...
    public AuthResponseDto getJwtTokensAfterAuthentication(Authentication authentication, HttpServletResponse response) {
        try
        {
            ...
            saveUserRefreshToken((UserInfoEntity) userInfoEntity,refreshToken);
            //Creating the cookie
            creatRefreshTokenCookie(response,refreshToken);
            log.info("[AuthService:userSignInAuth] Access token for user:{}, has been generated", ((UserInfoEntity) userInfoEntity).getUserName());
            return  AuthResponseDto.builder()
                    .accessToken(accessToken)
                    .accessTokenExpiry(15 * 60)
                    .userName(((UserInfoEntity) userInfoEntity).getUserName())
